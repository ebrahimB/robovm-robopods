...
public enum /*<name>*/NumberOfEmployees/*</name>*/ implements ValuedEnum {
    ...
    TwoToFive(1L),
    SixToTen(2L),
    ElevenToTwentyFive(3L),
    TwentySixToFifty(4L),
    FiftyOneToHundrend(5L),
    HundrendOneToTwoHundrendsFifty(6L),
    TwoHundrendsFiftyOneToFiveHundrends(7L),
    FiveHundrendsOneToThousand(8L),
    ThousandOneToFiveThousands(9L),
    GreaterThanFiveThousands(10L),
    DoNotWork(11L),
    PreferNotToSay(12L);
    /*</values>*/
