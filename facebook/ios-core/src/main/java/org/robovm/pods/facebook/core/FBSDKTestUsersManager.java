...
/*<javadoc>*/
/**
 * @deprecated FBSDKTestUsersManager is deprecated and will be removed in the next major release
 */
/*</javadoc>*/
...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/FBSDKTestUsersManager/*</name>*/ 
    ...
    public native void requestTestAccountTokens(NSArray<?> arraysOfPermissions, boolean createIfNotFound, @Block VoidBlock2<NSArray<FBSDKAccessToken>, NSError> handler);
    @Method(selector = "addTestAccountWithPermissions:completionHandler:")
    public native void addTestAccount(NSSet<NSString> permissions, @Block VoidBlock2<NSArray<FBSDKAccessToken>, NSError> handler);
    ...
    public static native FBSDKTestUsersManager sharedInstance(String appID, String appSecret);
    /*</methods>*/
}
