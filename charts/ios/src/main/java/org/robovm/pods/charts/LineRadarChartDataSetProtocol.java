...
/*<visibility>*/public/*</visibility>*/ interface /*<name>*/LineRadarChartDataSetProtocol/*</name>*/ 
    /*<implements>*/extends LineScatterCandleRadarChartDataSetProtocol/*</implements>*/ {
    ...
    void setFill(ChartFill v);
    @Property(selector = "fillAlpha")
    @MachineSizedFloat double getFillAlpha();
    @Property(selector = "setFillAlpha:")
    void setFillAlpha(@MachineSizedFloat double v);
    @Property(selector = "lineWidth")
    @MachineSizedFloat double getLineWidth();
    @Property(selector = "setLineWidth:")
    void setLineWidth(@MachineSizedFloat double v);
    @Property(selector = "drawFilledEnabled")
    boolean drawFilledEnabled();
    @Property(selector = "setDrawFilledEnabled:")
    void setDrawFilledEnabled(boolean v);
